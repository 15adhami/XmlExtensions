...
namespace XmlExtensions.Setting
{
    public class Range : KeyedSettingContainer
    {
        ...
        protected override void DrawSettingContents(Listing_Standard listingStandard, string selectedMod)
        {
            if (key2 == null)
            {
                IntRange range = IntRange.FromString(XmlMod.allSettings.dataDict[selectedMod + ";" + key]);
                ...
                GUI.color = currColor;
                XmlMod.allSettings.dataDict[selectedMod + ";" + key] = range.ToString();
            }
            else
            {
                ...
                //listingStandard.IntRange(ref range, min, max);
                GUI.color = currColor;
                XmlMod.allSettings.dataDict[selectedMod + ";" + key] = range.min.ToString();
                XmlMod.allSettings.dataDict[selectedMod + ";" + key2] = range.max.ToString();
            }
