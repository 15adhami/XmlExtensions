...
namespace XmlExtensions.Setting
{
    public class IntEntry : KeyedSettingContainer
    {
        ...
        {
            int f = int.Parse(XmlMod.allSettings.dataDict[selectedMod + ";" + key]);
            ...
            XmlMod.allSettings.dataDict[selectedMod + ";" + key] = value.ToString();
            
            
            
        }

        protected override int CalcHeight(float width, string selectedMod) { return (24 + XmlMod.menus[XmlMod.activeMenu].defaultSpacing); }
    }
}
