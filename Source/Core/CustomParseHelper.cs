...
namespace XmlExtensions
{
	...
	internal static class CustomParseHelper
	{
		public static class Parsers<T>
		{
			public static Func<string, XmlNode, XmlNode, T> parser;

			public static readonly string profilerLabel = "ParseHelper.FromString<" + typeof(T).FullName + ">()";

			public static void Register(Func<string, XmlNode, XmlNode, T> method)
			{
				parser = method;
				parsers.Add(typeof(T), (string str, XmlNode node, XmlNode root)=> method(str, node, root));
			}
		}

		private static Dictionary<Type, Func<string, XmlNode, XmlNode, object>> parsers;

		private static readonly char[] colorTrimStartParameters;

		private static readonly char[] colorTrimEndParameters;

		public static string ParseString(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			return str.Replace("\\n", "\n");
		}

		public static int ParseIntPermissive(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
		...
		public static Vector3 FromStringVector3(string Str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			Str = Str.TrimStart('(');
			Str = Str.TrimEnd(')');
		...
		public static Vector2 FromStringVector2(string Str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			Str = Str.TrimStart('(');
			Str = Str.TrimEnd(')');
			string[] array = Str.Split(',');
		...
		public static Vector4 FromStringVector4Adaptive(string Str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			Str = Str.TrimStart('(');
			Str = Str.TrimEnd(')');
			string[] array = Str.Split(',');
			...
			if (array.Length >= 5)
			{
				Verse.Log.ErrorOnce($"Too many elements in vector {Str}", 16139142);
			}
			return new Vector4(x, y, z, w);
		}

		public static Rect FromStringRect(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			str = str.TrimStart('(');
			str = str.TrimEnd(')');
			string[] array = str.Split(',');
		...
		public static float ParseFloat(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			return float.Parse(str, CultureInfo.InvariantCulture);
		}

		public static bool ParseBool(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			return bool.Parse(str);
		}

		public static long ParseLong(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			return long.Parse(str, CultureInfo.InvariantCulture);
		}

		public static double ParseDouble(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			return double.Parse(str, CultureInfo.InvariantCulture);
		}

		public static sbyte ParseSByte(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			return sbyte.Parse(str, CultureInfo.InvariantCulture);
		}

		public static Type ParseType(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			...
			{
				Verse.Log.Error("Could not find a type named " + str);
			}
			return typeInAnyAssembly;
		}

		public static System.Action ParseAction(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			string[] array = str.Split('.');
			...
			return (System.Action)Delegate.CreateDelegate(typeof(System.Action), method);
		}

		public static Color ParseColor(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			str = str.TrimStart(colorTrimStartParameters);
			str = str.TrimEnd(colorTrimEndParameters);
			string[] array = str.Split(',');
			float num = ParseFloat(array[0], xmlNode, xmlRoot);
			float num2 = ParseFloat(array[1], xmlNode, xmlRoot);
			float num3 = ParseFloat(array[2], xmlNode, xmlRoot);
			int num4;
			int num5;
			if (!(num > 1f) && !(num3 > 1f))
			{
			...
			if (array.Length == 4)
			{
				num6 = FromString<float>(array[3], xmlNode, xmlRoot);
			}
			if (num4 == 0)
			{
		...
		public static IntVec2 ParseIntVec2(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			return IntVec2.FromString(str);
		}

		public static IntVec3 ParseIntVec3(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			return IntVec3.FromString(str);
		}

		public static Rot4 ParseRot4(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			return Rot4.FromString(str);
		}

		public static CellRect ParseCellRect(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			return CellRect.FromString(str);
		}

		public static CurvePoint ParseCurvePoint(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			return CurvePoint.FromString(str);
		}

		public static NameTriple ParseNameTriple(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
		...
		public static FloatRange ParseFloatRange(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			return FloatRange.FromString(str);
		}

		public static IntRange ParseIntRange(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			return IntRange.FromString(str);
		}

		public static QualityRange ParseQualityRange(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			return QualityRange.FromString(str);
		}

		public static ColorInt ParseColorInt(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			str = str.TrimStart(colorTrimStartParameters);
			str = str.TrimEnd(colorTrimEndParameters);
			string[] array = str.Split(',');
			ColorInt result = new ColorInt(255, 255, 255, 255);
			result.r = ParseIntPermissive(array[0], xmlNode, xmlRoot);
			result.g = ParseIntPermissive(array[1], xmlNode, xmlRoot);
			result.b = ParseIntPermissive(array[2], xmlNode, xmlRoot);
			if (array.Length == 4)
			{
				result.a = ParseIntPermissive(array[3], xmlNode, xmlRoot);
			}
			else
			{
				result.a = 255;
		...
		public static TaggedString ParseTaggedString(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			return str;
		}

		static CustomParseHelper()
		{
			parsers = new Dictionary<Type, Func<string, XmlNode, XmlNode, object>>();
		...
		public static T FromString<T>(string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			Func<string, XmlNode, XmlNode, T> parser = Parsers<T>.parser;
			if (parser != null)
			{
				return parser(str, xmlNode, xmlRoot);
			}
			return (T)FromString(str, typeof(T), xmlNode, xmlRoot);
		}

		public static object FromString(string str, Type itemType, XmlNode xmlNode, XmlNode xmlRoot)
		{
			try
			{
				...
				{
					return value(str, xmlNode, xmlRoot);
				}
		...
		public static bool CanParse(Type type, string str, XmlNode xmlNode, XmlNode xmlRoot)
		{
			if (!HandlesType(type))
			{
				return false;
			...
			try
			{
				FromString(str, type, xmlNode, xmlRoot);
			}
