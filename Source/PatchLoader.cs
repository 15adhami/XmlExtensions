...
namespace XmlExtensions
{
	...
	public static class DirectXmlToPatch
	{
		...
		public static Func<XmlNode, bool, object> GetObjectFromXmlMethod(Type type)
		{
			...
			{
				MethodInfo method = typeof(DirectXmlToPatch).GetMethod("ObjectFromXmlReflection", BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
		...
		public static T ObjectFromXml<T>(XmlNode xmlRoot, bool doPostLoad)
		{
			...
			if (typeof(T).HasGenericDefinition(typeof(List<>)))
			{
				...
				{
					MethodInfo method = typeof(DirectXmlToPatch).GetMethod("ListFromXmlReflection", BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
			...
			if (typeof(T).HasGenericDefinition(typeof(Dictionary<,>)))
			{
				...
				{
					MethodInfo method2 = typeof(DirectXmlToPatch).GetMethod("DictionaryFromXmlReflection", BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic);
